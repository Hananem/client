...
const Jobs = () => {
    ...
    return (
        ...
        <div className="relative px-4 md:px-6 py-2">
            ...
            <div className="flex-1 lg:pl-72 mt-10">
    ...
    <div className="flex items-center mb-2 space-x-2">
        ...
        <button type="button" onClick={handleResetFilters} className="bg-gray-300 text-gray-700 px-4 py-2 rounded-md ml-2 hover:bg-gray-400">
            Reset Filters
                ...
                {loading ? (
                    ...
                    <JobListings jobs={jobs} onJobTitleClick={handleJobTitleClick} />
                )}
        ...
        {selectedJobId && <AnotherJob jobId={selectedJobId} closeModal={closeModal} />}
        </div>
    );
};
